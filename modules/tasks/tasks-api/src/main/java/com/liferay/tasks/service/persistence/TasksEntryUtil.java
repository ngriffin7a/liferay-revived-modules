...
public class TasksEntryUtil {
	...
	private static ServiceTracker<TasksEntryPersistence, TasksEntryPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(TasksEntryPersistence.class);

		ServiceTracker<TasksEntryPersistence, TasksEntryPersistence>
			serviceTracker =
				new ServiceTracker
					<TasksEntryPersistence, TasksEntryPersistence>(
						bundle.getBundleContext(), TasksEntryPersistence.class,
						null);
