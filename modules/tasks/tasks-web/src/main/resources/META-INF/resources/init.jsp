...
page import="com.liferay.tasks.service.TasksEntryLocalService" %><%@
...
page import="com.liferay.tasks.web.constants.TasksWebKeys" %>
...
<%
	...
	TasksEntryLocalService tasksEntryLocalService = (TasksEntryLocalService)request.getAttribute("tasksEntryLocalService");
%>