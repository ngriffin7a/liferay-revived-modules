...
public abstract class PowwowParticipantServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, PowwowParticipantService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PowwowParticipantService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		powwowParticipantService = (PowwowParticipantService)aopProxy;
	}
